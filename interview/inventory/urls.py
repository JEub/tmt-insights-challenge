...
from interview.inventory.views import  (
    InventoryLanguageListCreateView, InventoryLanguageRetrieveUpdateDestroyView, InventoryListCreateView, InventoryRetrieveUpdateDestroyView, InventoryTagListCreateView, InventoryTagRetrieveUpdateDestroyView, InventoryTypeListCreateView, InventoryTypeRetrieveUpdateDestroyView,InventoryListAfterDateView,
)
...
urlpatterns = [
    ...
    path("filter/<int:created_after>/", InventoryListAfterDateView.as_view())
]